...
public:
    CombatSlimeWindow() : player("texture/chevalierIdle.png", font, 100, sf::Vector2f(200, 750), sf::Vector2f(5.f, 5.f)),
        ...
        curseurSprite.setPosition(1370, 750);
        ...
        configureHealthText(slimeHealthText, slime.sprite, slime.health);
    }
    ...
    bool isCombatOver() {
        return (player.health == 0 || slime.health == 0);
    }
